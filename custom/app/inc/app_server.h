...
#define QST_UNNOMAL_SLEEP_INTERVAL 0x0100
#define QST_UNNOMAL_WAKE_INTERVAL  0x0101
#define QST_UNNOMAL_TRIGGER 0x0102
#define QST_NORMAL_ALARM    0x0104
#define QST_NOMAL_WAKE_INTERVAL    0x0105
